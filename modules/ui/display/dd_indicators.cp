#line 1 "C:/Users/sofia/Desktop/GIT REPO/SW-DP9_DPX/modules/ui/display/dd_indicators.c"
...
#line 1 "c:/users/sofia/desktop/git repo/sw-dp9_dpx/modules/ui/display/../../../libs/basic.h"
#line 27 "C:/Users/sofia/Desktop/GIT REPO/SW-DP9_DPX/modules/ui/display/dd_indicators.c"
...
void dd_Indicator_requestPrintUpdateP(Indicator* ind) {
 if(ind->pendingPrintUpdate !=  2 )
 ind->pendingPrintUpdate =  1 ;
}

void dd_Indicator_requestFullPrintUpdate(unsigned char indicatorIndex) {
 dd_currentIndicators[indicatorIndex]->pendingPrintUpdate =  2 ;
}

void dd_Indicator_clearPrintUpdateRequest(unsigned char indicatorIndex) {
 dd_currentIndicators[indicatorIndex]->pendingPrintUpdate =  0 ;
}
...
char dd_Indicator_isRequestingFullUpdate(unsigned char indicatorIndex) {
 return dd_currentIndicators[indicatorIndex]->pendingPrintUpdate ==  2 ;
}


void dd_Indicator_setStringValue(Indicator_ID id, char *value) {
 unsigned char indicatorIndex = dd_getIndicatorIndex(id);
 if(dd_currentIndicators[indicatorIndex]->valueType ==  0 )
 {
...
void dd_Indicator_setIntValue(Indicator_ID id, int value) {
 unsigned char indicatorIndex = dd_getIndicatorIndex(id);
 if (dd_currentIndicators[indicatorIndex]->valueType ==  1 ) {
...
void dd_Indicator_setFloatValue(Indicator_ID id, float value) {
 unsigned char indicatorIndex = dd_getIndicatorIndex(id);
 if (dd_currentIndicators[indicatorIndex]->valueType ==  2 ) {
...
void dd_Indicator_setBoolValue(Indicator_ID id, char value) {
 unsigned char indicatorIndex = dd_getIndicatorIndex(id);
 if (dd_currentIndicators[indicatorIndex]->valueType ==  3 ) {
...
void dd_Indicator_setAsVisible(unsigned char indicatorIndex) {
 dd_currentIndicators[indicatorIndex]->isVisible =  1 ;
}

void dd_Indicator_hide(unsigned char indicatorIndex) {
 dd_currentIndicators[indicatorIndex]->isVisible =  0 ;
}
...
void dd_Indicator_parseValueLabel(unsigned char indicatorIndex) {
 ...
 strcpy(indicator->label,  "T" );
 } else {
 strcpy(indicator->label,  "F" );
 }
 break;
 case  0 :
