...
#define DynamisFont_UniformTerminal_WIDTH 6
#define DynamisFont_UniformTerminal_HEIGHT 8
#define DynamisFont_UniformTerminal_OFFSET 32
#define DD_UniformTerminal_Font DynamisFont_UniformTerminal6x8,DynamisFont_UniformTerminal_WIDTH,DynamisFont_UniformTerminal_HEIGHT,DynamisFont_UniformTerminal_OFFSET


/**
   FIRST BYTE ALWAYS STORES CHAR WIDTH.
   THEN THE CHAR IS STORED BY DECOMPOSING THE BYTES IN THE FOLLOWING ORDER:
   FIRST MOVING VERTICALLY, THEN PASSING HORIZONTALLY TO THE NEXT VERTICAL TRAIT.
**/
