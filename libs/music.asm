...
;music.c,24 :: 		char Music_hasToMakeSound(void) {
;music.c,25 :: 		return music_isPlayingNote && (music_tickCounter > music_trentaduesimoTicks);
...
;music.c,28 :: 		void Music_tick(void) {
;music.c,29 :: 		if (music_tickCounter > 0) {
	MOV	_music_tickCounter, W0
	CP	W0, #0
	BRA GTU	L__Music_tick12
	GOTO	L_Music_tick2
L__Music_tick12:
;music.c,30 :: 		music_tickCounter -= 1;
	MOV	#1, W1
	MOV	#lo_addr(_music_tickCounter), W0
	SUBR	W1, [W0], [W0]
;music.c,31 :: 		if (music_tickCounter == 0) {
	MOV	_music_tickCounter, W0
	CP	W0, #0
	BRA Z	L__Music_tick13
	GOTO	L_Music_tick3
L__Music_tick13:
;music.c,32 :: 		Music_playSongNextNote();
...
;music.c,37 :: 		void Music_setSongTime(unsigned int time) {
;music.c,38 :: 		music_songTime = time;
...
;music.c,41 :: 		void Music_playSong(unsigned char song[], unsigned int songLength) {
;music.c,42 :: 		music_song = song;
	MOV	W10, _music_song
;music.c,43 :: 		music_songLength = songLength;
	MOV	W11, _music_songLength
;music.c,44 :: 		music_isPlaying = TRUE;
	MOV	#lo_addr(_music_isPlaying), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;music.c,45 :: 		music_currentNote = 0;
	CLR	W0
	MOV	W0, _music_currentNote
;music.c,46 :: 		Music_playSongNextNote();
	CALL	_Music_playSongNextNote
;music.c,47 :: 		}
...
;music.c,49 :: 		void Music_playSongNextNote(void) {
;music.c,51 :: 		if (music_currentNote < music_songLength) {
	PUSH	W10
	PUSH	W11
...
;music.c,52 :: 		note = *(music_song + music_currentNote);
	MOV	_music_song, W1
	MOV	#lo_addr(_music_currentNote), W0
	ADD	W1, [W0], W1
;music.c,53 :: 		duration = *(music_song + music_currentNote + 1);
	ADD	W1, #1, W0
;music.c,54 :: 		Music_playNote(note, duration);
	MOV.B	[W0], W11
	MOV.B	[W1], W10
	CALL	_Music_playNote
;music.c,55 :: 		music_currentNote += 2;
	MOV	#2, W1
	MOV	#lo_addr(_music_currentNote), W0
	ADD	W1, [W0], [W0]
;music.c,56 :: 		} else {
...
;music.c,57 :: 		music_isPlaying = FALSE;
	MOV	#lo_addr(_music_isPlaying), W1
	CLR	W0
	MOV.B	W0, [W1]
;music.c,58 :: 		}
...
L__Music_playNote19:
;music.c,64 :: 		music_isPlayingNote = FALSE;
	MOV	#lo_addr(_music_isPlayingNote), W1
	CLR	W0
	MOV.B	W0, [W1]
;music.c,65 :: 		timerPeriod = 0.001;
	MOV	#4719, W0
	MOV	#14979, W1
	MOV	W0, [W14+0]
	MOV	W1, [W14+2]
...
L_Music_playNote6:
;music.c,67 :: 		music_isPlayingNote = TRUE;
	MOV	#lo_addr(_music_isPlayingNote), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;music.c,68 :: 		timerPeriod = 1.0 / Music_getNoteFrequency(note);
...
;music.c,69 :: 		}
L_Music_playNote7:
;music.c,70 :: 		music_tickCounter = (unsigned int) (Music_getActualNoteDuration(duration) / timerPeriod);
	MOV.B	W11, W10
...
;music.c,71 :: 		music_trentaduesimoTicks = (unsigned int) (Music_getActualNoteDuration(TRENTADUESIMO) / timerPeriod);
	MOV.B	#1, W10
	CALL	_Music_getActualNoteDuration
	MOV	[W14+0], W2
	MOV	[W14+2], W3
...
;music.c,75 :: 		float Music_getActualNoteDuration(unsigned char duration) {
;music.c,76 :: 		return ((float) duration / (float) music_songTime) * 7.5; //60 / 8
	ZE	W10, W0
	CLR	W1
	CALL	__Long2Float
	MOV	W0, [W14+4]
...
;music.c,79 :: 		float Music_getNoteFrequency(unsigned char note) {
;music.c,80 :: 		return MUSIC_NOTE_TABLE[note];
	ZE	W10, W0
	SL	W0, #2, W1
